...
class ContentPage extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    List info = data.info.value;
    // ignore: invalid_use_of_protected_member
    List list = data.info.value;
                ...
                children: [
                    ...
                    child: Container(
                      ...
                      child: Row(
                        children: [
                          ...
                          CircleAvatar(
                            radius: 40,
                            backgroundImage: const AssetImage("img/images1.jpeg"),
                          ),
                          // ignore: prefer_const_constructors
                          SizedBox(
                            width: 10,
                  ...
                  Container(
                    ...
                    child: PageView.builder(
                        ...
                        // ignore: invalid_use_of_protected_member
                        itemCount: data.info.value == null
                            ? 0
                            // ignore: invalid_use_of_protected_member
                            : data.info.value.length,
                        itemBuilder: (_, i) {
